...
![Скрипт №1](image/Рис.2.png){ #fig:001 width=70% }
...
![Скрипт №3](image/Рис.10.png){ #fig:010 width=70% }
...
![Проверка работы скрипта](image/Рис.14.png){ #fig:014 width=70% }
...
![Создание файла](image/Рис.16.png){ #fig:016 width=70% }
